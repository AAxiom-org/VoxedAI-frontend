          ...
          {filteredNotes.map((note) => (
            ...
            >
              <div className="flex justify-between items-center">
                <div>
                  <h2 className="text-2xl font-medium mb-1 text-adaptive">
                    {getNoteTitleFromMetadata(note)}
                  </h2>
                  <p className="text-sm text-gray-700 dark:text-gray-300">
                    {getNoteDescriptionFromMetadata(note)}
                  </p>
                </div>
                <div className="flex items-center">
                  <div className="mr-2 text-primary">{user?.fullName}</div>
                  <div className="text-xl">
                    {getNoteEmojiFromMetadata(note)}
                  </div>
                </div>
              </div>
              ...
              <div
                className={`flex mt-4 ${hoveredNote === note.id ? "opacity-100" : "opacity-0"} transition-opacity duration-200`}
              >
                <input
                  type="checkbox"
